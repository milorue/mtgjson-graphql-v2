...
export const getSet = (set: string): Promise<APIResponse> => {
  return axios.get(apiURL + set + ".json").then((res) => res.data);
};

export const getSetList = (): Promise<APIResponse> => {
  return axios.get(apiURL + "SetList.json").then((res) => res.data);
};

export const getDeck = (deck: string): Promise<APIResponse> => {
  return axios.get(apiURL + "decks/" + deck + ".json").then((res) => res.data);
};

export const getDeckList = (): Promise<APIResponse> => {
  return axios.get(apiURL + "DeckList.json").then((res) => res.data);
};
...
export const getCompiledList = (): Promise<APIResponse> => {
  return axios.get(apiURL + "CompiledList.json").then((res) => res.data);
};

export const getKeywords = (): Promise<APIResponse> => {
  return axios.get(apiURL + "Keywords.json").then((res) => res.data);
};

export const getAllPrintings = (): Promise<APIResponse> => {
  return axios.get(apiURL + "AllPrintings.json").then((res) => res.data);
};
...
export const getPrices = (): Promise<APIResponse> => {
  return axios
    .get(apiURL + "AllPricesToday.json", {
      params: {
        _limit: 100,
      },
    })
